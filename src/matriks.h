...
indeks GetIdxBrsMin ();
/*Mengembalikan minimum indeks baris matriks apapus*/
indeks GetIdxKolMin ();
/*Mengembalikan indeks minimum dari kolom matriks apapun*/
indeks GetIdxBrsMax ();
/*Mengembalikan indeks maksimum dari baris matriks apapun*/
indeks GetIdxKolMax ();
/*Mengembalikan indeks maksimum kolom matriks apapun*/
...
boolean MatriksNEQ (MATRIKS M1, MATRIKS M2);
